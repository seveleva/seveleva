...
Приём основан на использовании мето­да перекрещивания слов через непроверяемую орфограмму. Алгоритмически крестообразная схема позволяет запоминать и быстро воспроизводить семанти­ческие модели этих слов.  (См. Приложение 3)
