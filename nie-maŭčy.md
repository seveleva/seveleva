...
<audio controls>
  <source src="assets/aŭdyjo/Chodziki.mp3" type="audio/mpeg">
Ваш браўзер не падтрымлівае гэты аўдыёэлемент.
</audio>
...
<audio controls>
  <source src="assets/aŭdyjo/Dzied-baradzied.mp3" type="audio/mpeg">
Ваш браўзер не падтрымлівае гэты аўдыёэлемент.
</audio>
...
<audio controls>
  <source src="assets/aŭdyjo/Buĺba.mp3" type="audio/mpeg">
Ваш браўзер не падтрымлівае гэты аўдыёэлемент.
</audio>
...
<audio controls>
  <source src="assets/aŭdyjo/Saŭka.mp3" type="audio/mpeg">
Ваш браўзер не падтрымлівае гэты аўдыёэлемент.
</audio>
...
— Мне ўсё гэта падарыў дзед на Восьмае сакавіка\! Толькі гэта не
...
[48](#anchor-33)).* Усе спяваюць і танцуюць.
...
статус и признание в (детском) коллективе. Особенно заметно это
...
зафиксирована и в официальных образовательных документах:
...
Пример такой разработки приведён на ст. [56](#anchor-4). Это
...
Обратная связь обычно осуществляется учителем и корректирует действия
...
также ожидаем, что такой процесс обучения оттянет на себя некоторое
...
регулярно представлялись на конкурсах и симпозиумах («Урок для
